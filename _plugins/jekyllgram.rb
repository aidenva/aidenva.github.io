...
module Jekyll
  ...
  class Jekyllgram < Liquid::Block
    ...
    def initialize(tag, params, token)
      @limit = params.to_i
      @access_token = ENV['IGQVJVMzRUWHhpVmRRVE1VYjlSdi04dmFiTWY5ZAG5xbU1xdUJzbUNVMEFfMjBrVEg5LUZAFOWNTMmppOTQyVEp4MnRvNF94cTItc1ZApSjZANTlhRYWswS1lCaTRSbkJ2T2FEb255Q2lTcEhFMnRlR1d2bAZDZD']
