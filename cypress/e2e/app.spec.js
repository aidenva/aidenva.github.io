...
describe('App', () => {
  ...
  it('should toggle darkmode', () => {
    cy.findByLabelText('toggle theme')
      .click()
      .should(() => {
        expect(localStorage.getItem('aidenva-theme')).to.eq('dark');
      })
      .click()
      .should(() => {
        expect(localStorage.getItem('aidenva-theme')).to.eq('light');
      });
  });
  ...
  it('should navigate to blog', () => {
    const editGithubUrl = `https://github.com/aidenva/aidenva.github.io/tree/develop/content/blog/exciting-new-features-in-javascript/index.md`;
