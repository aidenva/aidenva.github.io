...
> [check out the code](https://github.com/aidenva/gyrododge/blob/master/js/Player.js#L44)
...
> [check out the code](https://github.com/aidenva/GyroDodge/blob/master/js/Game.js)
