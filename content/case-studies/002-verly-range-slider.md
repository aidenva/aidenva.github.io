...
iframe: //codepen.io/aidenva/embed/agKJEd/?default-tab=result&theme-id=light
demo: //aidenva.github.io/VerlyRangeSlider
src: //github.com/aidenva/VerlyRangeSlider
...
info:
  ...
  links:
    - [ On Codepen, https://codepen.io/aidenva/pen/agKJEd ]
    - [ Verly.js - Physics engine that it uses, https://github.com/aidenva/Verly.js ]
    - [ Article at DataGenetic | Verlet Simulation , https://datagenetics.com/blog/july22018/index.html]
---

While I was building my physics engine [Verly.js](http://aidenva.github.io/Verly.js) I was thinking of making something that would showcase the engine's potential to do some exciting stuff, so I created this just as an experiment. 


- so far VerlyRangeSlider got over **18K Views** on [Codepen](https://codepen.io/aidenva/pen/agKJEd)
